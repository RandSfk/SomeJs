  ...
  `;
    ...
    const cardsMeta = [{
        ...
        },
        {
            ...
            link: "/main.php?op=perwalian_dashboard"
        },
        {
            title: "KHS",
            sub: "Download hasil studi semester kamu.",
            link: "/main.php?op=mahasiswa_khs&act=cetak"
        },
        {
            title: "KRS",
        ...
        },
        {
            ...
            link: "/main.php?op=data_jawaban_head&act=materi"
        },
        {
            title: "Ruang Tugas",
            sub: "Upload jawaban tugas kuliah.",
            link: "/main.php?op=data_jawaban_head"
        },
        {
            title: "Ruang Quiz",
            sub: "Upload jawaban quiz.",
            link: "/main.php?op=data_quiz_head"
        },
        {
            title: "Tugas Kelompok",
            sub: "Masuk ke ruang tugas kelompok.",
            link: "/main.php?op=tugas_kelompok"
        }
    ];

    const BASE = "https://elearning.universitasmandiri.ac.id/admin/";
    ...
    const overlayCards = cardsMeta.map(meta => ({
        ...meta,
        link: toFull(meta.link)
    }));

    const hub = document.createElement("div");
    hub.id = "genz-fixed-hub";
    hub.innerHTML = `
  <button class="hub-btn" id="genz-open-btn">Buka Menu</button>
`;
  ...
  <div class="genz-modal">
    <div class="hub-top">
      <div class="hub-title">
        <h2>Dashboard</h2>
        <p>Menu custom (bukan dari element lama).</p>
      </div>
